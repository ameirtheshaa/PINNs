...
ladefense_sampled_epoch = 5262
ladefense_full_epoch = 272
ladefense_pca_epoch = 702
...
##################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################
# base_folders = [os.path.join('Z:\\', "ladefense", "19022024_adam_datalossonly_sampled_70_70_10_infinite_ladefense", f"vtk_output_{ladefense_sampled_epoch}"), os.path.join('Z:\\', "ladefense", "16012024_adam_datalossonly_infinite", f"vtk_output_{ladefense_full_epoch}")]
# base_folders = [os.path.join('Z:\\', "ladefense", "19022024_adam_datalossonly_sampled_70_70_10_infinite_ladefense", f"vtk_output_{ladefense_sampled_epoch}")]
# base_folders = [os.path.join('Z:\\', "ladefense", "11032024_adam_datalossonly_infinite_ladefense_PCA", f"vtk_output_{ladefense_pca_epoch}")]
base_folders = [os.path.join('Z:\\', "ladefense", "16012024_adam_datalossonly_infinite", f"vtk_output_{ladefense_full_epoch}")]
...
# slice_params = [['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 260), (0, 0, 1), 1000, 50]]
# slice_params = [['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 260), (0, 0, 1), 1000, 50],['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 261), (0, 0, 1), 1000, 50],['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 262), (0, 0, 1), 1000, 50],['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 263), (0, 0, 1), 1000, 50],['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 264), (0, 0, 1), 1000, 50], ['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 265), (0, 0, 1), 1000, 50], ['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 266), (0, 0, 1), 1000, 50], ['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 268), (0, 0, 1), 1000, 50], ['yz', np.array([1, 0, 0]), np.array([0, 0, -1]), (0, 100, 269), (0, 0, 1), 1000, 50]]
##################################################################################################################################################################################################################################################################################################################################################################################################################################################################################################

parameters_block = [['Velocity', 'Velocity_Predicted']]
all_physics = ['Testing', 'Evaluation_Skipped_Angle']
...
def plot_paraview_predictions_streamtracer(base_folder, physics, parameters, slice_param):
    ...
    for filename in filenames:
        ...
        image_actual = base_plotting(base_folder, filename, parameters[0], plane, plane_point, image_res, rotation_vector, cam_pos, cam_foc, cam_up, mask_points)
