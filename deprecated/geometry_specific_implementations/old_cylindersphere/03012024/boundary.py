...
def no_slip_boundary_conditions(device, flattened_mesh, wind_angles, feature_scaler, target_scaler):
    """
    ...
    for wind_angle in wind_angles:
        ...
        no_slip_features_normals.append(no_slip_points, no_slip_normals)

    return no_slip_features_normals

def sample_domain_boundary(config, device, filenames, datafolder_path, wind_angles, feature_scaler, target_scaler):
    ...
    for wind_direction in wind_angles:
        ...
        if len(df_all) != 0:
            ...
            all_inlet_features_targets.append([normalized_features_tensor, normalized_targets_tensor])
