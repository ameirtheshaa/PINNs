...
config = {
    ...
    "base_folder_name": '15122023_adam_datalosscontlossnosliplossinletloss_infinite'
}
...
config["loss_components"]["use_weighting"] = False
...
config["base_folder_name"] = "18122023_adam_datalossonly_infinite"
