...
def make_scatter_plot(figsize, z, grid1, grid2, grid3, geometry1, geometry2, plane, wind_angle, cut, tolerance, cbar_label, savename):
...
def plot_differences(df, plane, wind_angle, cut, tolerance, geometry_filename, savenames):
    coordinate1, coordinate2, coordinate3, lim_min1, lim_max1, lim_min2, lim_max2 = get_plane_config(plane)
...
def plot_diff_2d(config,df,wind_angles,geometry_filename,plot_folder):
    ...
    for wind_angle in wind_angles:
        for j in params:
            ...
            plot_differences(df, plane, wind_angle, cut, tolerance, geometry_filename, savenames_scatter_single)
