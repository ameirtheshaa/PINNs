...
config = {
    ...
    "base_folder_name": '12102023_adam_datalossallphysicsloss_infinite'
}
...
if __name__ == "__main__":
    ...
    if chosen_machine == "lxplus":
        ...
        base_directory = os.path.join(config[chosen_machine]["base_name"], 'abandoned', config["base_folder_name"])
