...
config = {
    ...
    "machine": {
        ...
        "google_local": "/content/",
        "google_notameirshaa": "/content/drive/MyDrive/"
    },
    "plotting": {
    ...
    "loss_components": {
        ...
        "adaptive_weighting_initial_weight": 0.7,
        "adaptive_weighting_final_weight": 0.5,
        # "weighting_scheme": 'gradient_magnitude',
    },
    "train_test": {
        "train": True,
...
config["base_folder_name"] = "18122023_adam_datalossnosliploss_infinite_adaptiveweighting"
