...
def testing(config, device, output_folder, model_file_path, model, today, overall_start_time):
...
def evaluation(config, device, output_folder, model_file_path, model, today, overall_start_time):
...
def evaluation_new_angles(config, device, output_folder, model_file_path, model, today, overall_start_time):
    ...
    base_testing(config, device, model_file_path, model, new_wind_angles, X_test_tensor_new, feature_scaler, target_scaler, newangles_plot_folder, overall_start_time, testing_type)
