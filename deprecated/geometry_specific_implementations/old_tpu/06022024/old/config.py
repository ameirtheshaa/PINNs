...
config = {
    ...
    # "base_folder_names": ["11112023_both_datalosscontloss_infinite", "21102023_adam_datalossonly_infinite", "29102023_both_datalosscontloss_infinite"]
    "base_folder_names": ["26112023_adam_datalossonly_infinite", "02122023_adam_datalosscontlossnosliplossinletloss_infinite", "02122023_adam_datalossnosliplossinletloss_infinite", "29112023_adam_datalossnosliplossloss_infinite"]
}
