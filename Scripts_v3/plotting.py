...
def plot_data(df,angle,config,savename_total_velocity,savename_vx,savename_vy,savename_vz,savename_pressure,plane,cut,tolerance):
    wind_angle = angle
    if plane == 'X-Z':
        points = ['X', 'Z']
        noplotdata = 'Y'
    ...
    if config["plotting"]["make_pure_data_plots_vx"] and not Path(savename_vx).exists():
        ...
        contour = ax.contourf(grid1, grid2, grid_vx, levels=128, cmap=cmap)
        if config["plotting"]["make_pure_data_plots_quiver"]:
            ax.quiver(quiver_points1, quiver_points2, quiver_v1, quiver_v2, scale=200, color='white')
        ax.scatter(spherefill1, spherefill2, c='black', s=1, label='Sphere Fill')
        ax.scatter(cylinderfill1.ravel(),  cylinderfill2.ravel(), c='black', s=1, label='Cylinder Body Fill')
    ...
    if config["plotting"]["make_pure_data_plots_vy"] and not Path(savename_vy).exists():
        ...
        contour = ax.contourf(grid1, grid2, grid_vy, levels=128, cmap=cmap)
        if config["plotting"]["make_pure_data_plots_quiver"]:
            ax.quiver(quiver_points1, quiver_points2, quiver_v1, quiver_v2, scale=200, color='white')
        ax.scatter(spherefill1, spherefill2, c='black', s=1, label='Sphere Fill')
        ax.scatter(cylinderfill1.ravel(),  cylinderfill2.ravel(), c='black', s=1, label='Cylinder Body Fill')
    ...
    if config["plotting"]["make_pure_data_plots_vz"] and not Path(savename_vz).exists():
        ...
        contour = ax.contourf(grid1, grid2, grid_vz, levels=128, cmap=cmap)
        if config["plotting"]["make_pure_data_plots_quiver"]:
            ax.quiver(quiver_points1, quiver_points2, quiver_v1, quiver_v2, scale=200, color='white')
        ax.scatter(spherefill1, spherefill2, c='black', s=1, label='Sphere Fill')
        ax.scatter(cylinderfill1.ravel(),  cylinderfill2.ravel(), c='black', s=1, label='Cylinder Body Fill')
    ...
    if config["plotting"]["make_pure_data_plots_pressure"] and not Path(savename_pressure).exists():
        ...
        contour = ax.contourf(grid1, grid2, grid_pressure, levels=128, cmap=cmap)
        if config["plotting"]["make_pure_data_plots_quiver"]:
            ax.quiver(quiver_points1, quiver_points2, quiver_v1, quiver_v2, scale=200, color='white')
        ax.scatter(spherefill1, spherefill2, c='black', s=1, label='Sphere Fill')
        ax.scatter(cylinderfill1.ravel(),  cylinderfill2.ravel(), c='black', s=1, label='Cylinder Body Fill')
...
def plot_data_predictions(df,angle,config,savename_all,savename_total_velocity,savename_vx,savename_vy,savename_vz,savename_pressure,plane,cut,tolerance):
    wind_angle = angle
    if plane == 'X-Z':
        points = ['X', 'Z']
        noplotdata = 'Y'
    ...
    if config["plotting"]["make_comparison_total_velocity"]:
    ...
    if config["plotting"]["make_comparison_vx"]:
        fig, axs = plt.subplots(1, 2, figsize=(16, 8), sharey=True)
        fig.suptitle(f'Comparison of Actual vs. Predicted values with Wind Angle = {wind_angle} in the {plane} Plane with a cut at {coordinate3} = {cut:.2f} +/- {tolerance:.2f}')
    ...
    if config["plotting"]["make_comparison_vy"]:
        fig, axs = plt.subplots(1, 2, figsize=(16, 8), sharey=True)
        fig.suptitle(f'Comparison of Actual vs. Predicted values with Wind Angle = {wind_angle} in the {plane} Plane with a cut at {coordinate3} = {cut:.2f} +/- {tolerance:.2f}')
    ...
    if config["plotting"]["make_comparison_vz"]:
        fig, axs = plt.subplots(1, 2, figsize=(16, 8), sharey=True)
        fig.suptitle(f'Comparison of Actual vs. Predicted values with Wind Angle = {wind_angle} in the {plane} Plane with a cut at {coordinate3} = {cut:.2f} +/- {tolerance:.2f}')
    ...
    if config["plotting"]["make_comparison_pressure"]:
        fig, axs = plt.subplots(1, 2, figsize=(16, 8), sharey=True)
        fig.suptitle(f'Comparison of Actual vs. Predicted values with Wind Angle = {wind_angle} in the {plane} Plane with a cut at {coordinate3} = {cut:.2f} +/- {tolerance:.2f}')
...
def plot_data_new_angles(df,angle,config,savename_total_velocity,savename_vx,savename_vy,savename_vz,savename_pressure,plane,cut,tolerance):
    wind_angle = angle
    if plane == 'X-Z':
        points = ['X', 'Z']
        noplotdata = 'Y'
...
def plot_data_2d(df,angle,config,plot_folder):
    ...
    for j in params:
        ...
        plot_data(df,angle,config,savename_total_velocity,savename_vx,savename_vy,savename_vz,savename_pressure,plane,cut,tolerance)
...
def plot_prediction_2d(df,angle,config,plot_folder):
    ...
    for j in params:
        ...
        savename_vz = os.path.join(plot_folder,f'{plane}_vz_{angle}.png')
        savename_pressure = os.path.join(plot_folder,f'{plane}_pressure_{angle}.png')
        plot_data_predictions(df,angle,config,savename_all,savename_total_velocity,savename_vx,savename_vy,savename_vz,savename_pressure,plane,cut,tolerance)
...
def plot_new_angles_2d(df,angle,config,plot_folder):
    ...
    for j in params:
        ...
        savename_vz = os.path.join(plot_folder,f'{plane}_vz_{angle}.png')
        savename_pressure = os.path.join(plot_folder,f'{plane}_pressure_{angle}.png')
        plot_data_new_angles(df,angle,config,savename_total_velocity,savename_vx,savename_vy,savename_vz,savename_pressure,plane,cut,tolerance)