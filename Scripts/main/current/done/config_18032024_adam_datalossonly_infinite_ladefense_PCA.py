...
config["training"]["neuron_number"] = 32
config["training"]["boundary"] = [[-2520,2520,-2520,2520,0,1000],100]
config["loss_components"]["data_loss"] = True
config["base_folder_name"] = "18032024_adam_datalossonly_infinite_ladefense_PCA"
config["chosen_optimizer"] = "lbfgs_optimizer"

#first 10k epochs
config["lbfgs_optimizer"]["learning_rate"] = 1e-8
