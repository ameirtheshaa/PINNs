...
def base_testing(config, device, base_output_folder, model_file_path, model, wind_angles, X_test_tensor, feature_scaler, target_scaler, plot_folder, overall_start_time, testing_type, y_test_tensor, data_folder, pca_rows, pca_columns, original_shape):
    ...
    df = evaluate_model_PCA(config, model, wind_angles, X_test_tensor, feature_scaler, target_scaler, y_test_tensor, pca_rows, pca_columns, original_shape, data_folder, testing_type, vtk_output_folder)
...
def testing(model, device, config, data_dict, model_file_path, output_folder, today, overall_start_time):
    ...
    X_train_tensor, y_train_tensor, X_test_tensor_skipped, y_test_tensor_skipped, feature_scaler, target_scaler, pca_rows, pca_columns, original_shape = data_dict.values()
    base_testing(config, device, output_folder, model_file_path, model, training_wind_angles, X_train_tensor, feature_scaler, target_scaler, testing_plot_folder, overall_start_time, testing_type, y_train_tensor, testing_data_folder, pca_rows, pca_columns, original_shape)
...
def evaluation(model, device, config, data_dict, model_file_path, output_folder, today, overall_start_time):
    ...
    X_train_tensor, y_train_tensor, X_test_tensor_skipped, y_test_tensor_skipped, feature_scaler, target_scaler, pca_rows, pca_columns, original_shape = data_dict.values()
    base_testing(config, device, output_folder, model_file_path, model, skipped_wind_angles, X_test_tensor_skipped, feature_scaler, target_scaler, skipped_plot_folder, overall_start_time, testing_type, y_test_tensor_skipped, skipped_data_folder, pca_rows, pca_columns, original_shape)
