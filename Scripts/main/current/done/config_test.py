...
config["base_folder_names"] = ["16012024_adam_datalossonly_infinite", "30012024_adam_datalossonly_infinite_reduced"]
...
# config["base_folder_names"] = ["16012024_adam_datalossonly_infinite_continued_test", "19012024_adam_cont_boundary_RANS_loss_infinite"]
