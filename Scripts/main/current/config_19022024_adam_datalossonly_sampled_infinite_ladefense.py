...
config["data"]["startname_data"] = "Sampled_70_70_10_CFD_"
config["train_test"]["test_size"] = 0.1
config["train_test"]["train"] = True
config["training"]["use_batches"] = True
config["training"]["batch_size"] = 2**17
config["training"]["print_epochs"] = 1
config["training"]["boundary"] = [[-2520,2520,-2520,2520,0,1000],100]
config["training"]["output_params"] = ['Velocity:0', 'Velocity:1', 'Velocity:2']
config["training"]["output_params_modf"] = ['Velocity_X', 'Velocity_Y', 'Velocity_Z']
config["loss_components"]["data_loss"] = True
config["base_folder_name"] = "19022024_adam_datalossonly_sampled_70_70_10_infinite_ladefense"
