...
def load_data(config, device):
    ...
    data_dict = {
        ...
        "X_train_tensor_data": X_train_tensor_data,
        "y_train_tensor_data": y_train_tensor_data,
        "X_test_tensor_data": X_test_tensor_data,
        "y_test_tensor_data": y_test_tensor_data,
